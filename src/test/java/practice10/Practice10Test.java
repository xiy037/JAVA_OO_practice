...
public class Practice10Test {
  ...
  @Test
  public void shouldReturn_teacher_announceMember() {
    Klass klass5 = new Klass(5);
    Klass[] klasses = {klass};
    Teacher tom = new Teacher(1,"Tom", 21, klasses);
    Student jerry = new Student(2, "Jerry", 20, klass5);
    klass.appendMember(jerry);
    assertEquals("I am Tom. I know Jerry has joined Klass 2.\n", systemOut());
  }

  @Test
  public void shouldReturn_teacher_announceLeader() {
    Klass klass3 = new Klass(3);
    Klass[] klasses = {klass, klass3};
    Teacher tom = new Teacher(1,"Tom", 21, klasses);
    Student jerry = new Student(2, "Jerry", 20, klass3);
    klass3.assignLeader(jerry);
    assertEquals("I am Tom. I know Jerry has become Leader of Klass 3.\n", systemOut());
  }
}
